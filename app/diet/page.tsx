  ...
  return (
    <div className="min-h-screen pb-24">
      <div className="bg-gradient-to-br from-teal-500 to-cyan-400 px-5 pt-12 pb-8 text-white">
        ...
        <p className="text-teal-100 text-sm mt-1">Personalized Bangladeshi meal suggestions</p>
      </div>
      <div className="max-w-lg mx-auto px-4 mt-6">
        <div className="card text-center text-gray-400 py-12">
          <div className="text-4xl mb-3">🚧</div>
          <p className="font-medium">Coming in next step!</p>
          <p className="text-sm mt-1">AI diet recommendations will be built here.</p>
        </div>
      </div>
      <Navbar />
    </div>
